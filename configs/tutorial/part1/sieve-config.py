...
default_binary = os.path.join(
    thispath,
    "../../../",
    "tests/test-progs/sieve-X86/sieve",
)

# Binary to execute
SimpleOpts.add_option("--cpu-type", default="timing",
    help="CPU model: timing | minor (default: timing)")
SimpleOpts.add_option("--clk", default="1GHz",
    help="CPU clock frequency, e.g. 1GHz/2GHz/4GHz (default: 1GHz)")
SimpleOpts.add_option("--mem-type", default="DDR3_1600_8x8",
    help=("Memory interface: "
...
system.cpu.icache.size = "32KiB"
system.cpu.dcache = L1DCache(args)
system.cpu.dcache.size = "32KiB"
...
process.cmd = [args.binary, "1000000"]
